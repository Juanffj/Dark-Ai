...
let handler = async (m, { conn, text, command, usedPrefix }) => {
  ...
  if (corazones > users.cookies) return conn.reply(m.chat, "🤍 No tienes suficientes *🤍 Corazones* para realizar esa apuesta.", m, rcanal)
  ...
  setTimeout(() => {
    ...
    if (win) {
      ...
      conn.reply(m.chat, `🤍 ¡Ganaste! Obtuviste ${cookies} *🤍 Corazones*. Total: ${users.corazones} *🤍 Corazones*.`, m, rcanal)
    } else {
